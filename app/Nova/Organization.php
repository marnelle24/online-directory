    ...
    public function fields(Request $request)
    {
        ...
        return [
            ...
            Select::make('Category', 'category_id')
                ->searchable()
                ->options(function() {
                    return array_filter(\App\Models\OrgCategory::pluck('name', 'id')->toArray());
                })
                ->hideFromIndex()
                ->hideFromDetail()
                ->hideWhenUpdating()
            ...
            Tabs::make('Contact Details', [
                HasMany::make('Contact Details', 'contacts_details', 'App\Nova\OrgContactDetails')
                    ->hideFromIndex(),
            ])->defaultSearch(true),
